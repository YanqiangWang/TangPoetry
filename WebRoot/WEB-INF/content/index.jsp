		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<img class="img-responsive center-block" alt="全唐诗搜索网站"
					...
					onclick="window.location.href='${pageContext.request.contextPath}/Initiate.action'" />
			</div>
		</div>
							...
							<div class="input-group">
								...
								<div class="input-group-btn">
									...
									<ul class="dropdown-menu dropdown-menu-right"
										style="min-width: 100%">
										<li><a style="cursor: pointer" onclick="method_author()">作者</a>
										</li>
										<li><a style="cursor: pointer" onclick="method_title()">标题</a>
										</li>
										<li><a style="cursor: pointer" onclick="method_content()">内容</a>
										</li>
									</ul>
								</div>
							</div>
