...
import com.poetry.util.DBUtil;

/**
 * 诗词DAO
 * 
 * @author Yanqiang
 * @date Apr 3, 2017 1:40:53 AM
 * @Description
 */
public class PoetryDao {
	 ...
	 * @return 诗题列表
	 */
	public List<String> searchTitleByPoetAndTitle(String title, int poetId, Page page) {
	 ...
	 * @return 诗题列表
	 */
	public List<String> searchTitleByPoetAndContent(String content, int poetId, Page page) {
	 ...
	 * @return 诗题列表
	 */
	private List<String> fuzzySearchTitle(String sql, String str, int poetId, Page page) {
		titles.clear();
		conn = DBUtil.getConnection();
		try {
			pstmt = conn.prepareStatement(sql);
